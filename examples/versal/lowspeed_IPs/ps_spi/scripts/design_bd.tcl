...
EMIO} {GRP_SS2_ENABLE 1} {GRP_SS2_IO EMIO} {PERIPHERAL_ENABLE 1}\
{PERIPHERAL_IO EMIO}}\
     PS_SPI1 {{GRP_SS0_ENABLE 1} {GRP_SS0_IO EMIO} {GRP_SS1_ENABLE 0} {GRP_SS1_IO\
{PS_MIO 8}} {GRP_SS2_ENABLE 0} {GRP_SS2_IO {PS_MIO 7}}\
{PERIPHERAL_ENABLE 1} {PERIPHERAL_IO EMIO}}\
  ...
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_pins axis_ila_0/probe9] [get_bd_pins util_reduced_logic_0/Res] [get_bd_pins versal_cips_0/SPI1_ss_i]
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_pins axis_ila_0/probe6] [get_bd_pins util_reduced_logic_1/Res] [get_bd_pins versal_cips_0/SPI0_ss_i]
  connect_bd_net -net versal_cips_0_SPI0_io0_o [get_bd_pins axis_ila_0/probe1] [get_bd_pins versal_cips_0/SPI0_io0_o] [get_bd_pins versal_cips_0/SPI1_io0_i]
  connect_bd_net -net versal_cips_0_SPI0_io1_o [get_bd_pins axis_ila_0/probe5] [get_bd_pins versal_cips_0/SPI0_io1_o] [get_bd_pins versal_cips_0/SPI1_io1_i]
  connect_bd_net -net versal_cips_0_SPI0_sck_o [get_bd_pins axis_ila_0/probe0] [get_bd_pins versal_cips_0/SPI0_sck_o] [get_bd_pins versal_cips_0/SPI1_sck_i]
  connect_bd_net -net versal_cips_0_SPI0_ss_o [get_bd_pins axis_ila_0/probe3] [get_bd_pins util_reduced_logic_0/Op1] [get_bd_pins versal_cips_0/SPI0_ss_o]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets versal_cips_0_SPI0_ss_o]
  connect_bd_net -net versal_cips_0_SPI1_io0_o [get_bd_pins axis_ila_0/probe4] [get_bd_pins versal_cips_0/SPI0_io0_i] [get_bd_pins versal_cips_0/SPI1_io0_o]
  connect_bd_net -net versal_cips_0_SPI1_io1_o [get_bd_pins axis_ila_0/probe2] [get_bd_pins versal_cips_0/SPI0_io1_i] [get_bd_pins versal_cips_0/SPI1_io1_o]
  connect_bd_net -net versal_cips_0_SPI1_sck_o [get_bd_pins axis_ila_0/probe8] [get_bd_pins versal_cips_0/SPI0_sck_i] [get_bd_pins versal_cips_0/SPI1_sck_o]
  connect_bd_net -net versal_cips_0_SPI1_ss_o [get_bd_pins axis_ila_0/probe7] [get_bd_pins util_reduced_logic_1/Op1] [get_bd_pins versal_cips_0/SPI1_ss_o]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets versal_cips_0_SPI1_ss_o]
  ...
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins axis_ila_0/clk] [get_bd_pins versal_cips_0/pl0_ref_clk]
