...
XUartLite UartLite_1, UartLite_2;		/* Instance of the UartLite Device */
...
int UartLitePolledExample(u16 DeviceId)
{
	 ...
	 */
	SentCount = XUartLite_Send(&UartLite_1, SendBuffer, TEST_BUFFER_SIZE);
	 ...
	 */
	while (1) {
		ReceivedCount += XUartLite_Recv(&UartLite_2,
