...
static int SetupInterruptSystem(XCanFd  *InstancePtr, int id);
...
static int XCanFdIntrExample(u16 DeviceId)
{
	...
	Status = XCanFd_CfgInitialize(CanFdInstPtr_1,
				ConfigPtr_1,ConfigPtr_1->BaseAddress);
	if (Status != XST_SUCCESS) {
		return XST_FAILURE;
	}
	Status = XCanFd_CfgInitialize(CanFdInstPtr_2,
					ConfigPtr_2,ConfigPtr_2->BaseAddress);
		if (Status != XST_SUCCESS) {
			return XST_FAILURE;
		}
	/*
	...
	Config(CanFdInstPtr_1);
	Config(CanFdInstPtr_2);

	XCanFd_SetHandler(CanFdInstPtr_1, XCANFD_HANDLER_SEND,
			(void *)SendHandler, (void *)CanFdInstPtr_1);
	XCanFd_SetHandler(CanFdInstPtr_1, XCANFD_HANDLER_RECV,
			(void *)RecvHandler, (void *)CanFdInstPtr_1);
	XCanFd_SetHandler(CanFdInstPtr_1, XCANFD_HANDLER_ERROR,
			(void *)ErrorHandler, (void *)CanFdInstPtr_1);
	XCanFd_SetHandler(CanFdInstPtr_1, XCANFD_HANDLER_EVENT,
			(void *)EventHandler, (void *)CanFdInstPtr_1);

	XCanFd_SetHandler(CanFdInstPtr_2, XCANFD_HANDLER_SEND,
			(void *)SendHandler, (void *)CanFdInstPtr_2);
	XCanFd_SetHandler(CanFdInstPtr_2, XCANFD_HANDLER_RECV,
			(void *)RecvHandler, (void *)CanFdInstPtr_2);
	XCanFd_SetHandler(CanFdInstPtr_2, XCANFD_HANDLER_ERROR,
			(void *)ErrorHandler, (void *)CanFdInstPtr_2);
	XCanFd_SetHandler(CanFdInstPtr_2, XCANFD_HANDLER_EVENT,
			(void *)EventHandler, (void *)CanFdInstPtr_2);
	...
	XCanFd_InterruptEnable(CanFdInstPtr_1, XCANFD_IXR_ALL);
	XCanFd_InterruptEnable(CanFdInstPtr_2, XCANFD_IXR_ALL);
	...
	XCanFd_Recv_Sequential(CanFdInstPtr_2, RxFrame);

	for(int data = 2; data < XCANFD_MAX_FRAME_SIZE_IN_BYTES; data++)
	{
		if(RxFrame[data] != TxFrame[data])
		return XST_FAILURE;
	}
...
*
****************************************************************************/
static int SetupInterruptSystem(XCanFd *InstancePtr, int int_id)
{
	...
	XScuGic_SetPriorityTriggerType(&InterruptController, int_id,
					0xA0, 0x3);
