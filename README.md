...
<th width="100%" colspan="6"><img src="https://www.xilinx.com/content/dam/xilinx/imgs/press/media-kits/corporate/xilinx-logo.png" width="30%"/><h1>Zync UltraScale+ MPSoC Embedded Design Tutorial 2020.2 (UG1209)</h1>
  ...
  <tr>
    ...
    <td width="16%" align="center"><a href=".docs/2-getting-started/2-getting-started.md">2. Getting Started</a></td>
    <td width="17%" align="center"><a href=".docs/3-system-configuration/3-system-configuration.md">3. Zynq UltraScale+ MPSoC System Configuration</a></td>
    <td width="17%" align="center"><a href=".docs/4-build-sw-for-ps-subsystems/4-build-sw-for-ps-subsystems.md">4. Build Software for PS Subsystems</a></td>
</tr>
<tr>
    <td width="17%" align="center"><a href=".docs/5-debugging-with-vitis-debugger/5-debugging-with-vitis-debugger.md">5. Debugging with the Vitis Debugger</a></td>
    <td width="16%" align="center"><a href=".docs/6-boot-and-configuration/6-boot-and-configuration.md">6. Boot and Configuration</a></td>
    <td width="17%" align="center"><a href=".docs/7-system-design-examples/7-system-design-examples.md">7. System Design Examples</a></td>
    <td width="17%" align="center"><a href=".docs/8-debugging-problems-with-secure-boot/8-debugging-problems-with-secure-boot.md">8. Debugging Problems with Secure Boot</a></td>    
  </tr>
</table>
...
# Introduction
 ...
 [Build Software for PS Subsystems](./docs/4-build-sw-for-ps-subsystems/#4-build-sw-for-ps-subsystems.md) describes
 ...
 [Debugging with the Vitis Debugger](./docs/5-debugging-with-vitis-debugger/#5-debugging-with-vitis-debugger) provides an
 ...
 [Boot and Configuration](./docs/6-boot-and-configuration/#6-boot-and-configuration.md) shows integration of
 ...
 [System Design Examples](./docs/7-system-design-examples/#7-system-design-examples) highlights how you
 can use the software blocks you configured in [Build
 Software for PS Subsystems](./docs/4-build-sw-for-ps-subsystems/#4-build-sw-for-ps-subsystems.md) to create a Zynq UltraScale+ system.
