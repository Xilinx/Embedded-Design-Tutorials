...
Learn how to `use the Xilinx® Vivado® Design Suite flow for a VMK180/VCK190 evaluation board <./1-getting-started.html>`__.
...
.. list-table:: 
   ...
   * - `Creating a New Embedded Project with the Versal ACAP <./2-cips-noc-ip-config.html#creating-a-new-embedded-project-with-the-versal-acap>`__
