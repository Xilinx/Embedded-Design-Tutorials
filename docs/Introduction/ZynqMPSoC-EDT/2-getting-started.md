...
- If the examples can be run in script mode, the `ref_files` directory will contain the `Makefile` to help you run through the flow easily. Run `make` in this directory to run through the implementation flow.
