...
2. `Getting Started <./2-getting-started>`__
3. `Zynq UltraScale+ MPSoC System Configuration with Vivado <./3-system-configuration>`__
...
4. `Building Software for PS Subsystems <./4-build-sw-for-ps-subsystems>`__
...
5. `Debugging Standalone Applications with the Vitis Debugger <./5-debugging-with-vitis-debugger>`__
...
6. `Building and Debugging Linux Applications <./6-build-linux-sw-for-ps>`__
...
7. `System Design Example: Using GPIO, Timer and Interrupts <./7-design1-using-gpio-timer-interrupts>`__
...
8. `Boot and Configuration <./8-boot-and-configuration>`__
...
9. `Secure Boot <./9-secure-boot>`__
