...
> 2. This example uses the [ZCU102 PetaLinux BSP](https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/embedded-design-tools.html) to create a PetaLinux project. Ensure that you have downloaded the ZCU102 BSP for PetaLinux as instructed on the [PetaLinux Tools download page](https://www.xilinx.com/member/forms/download/xef.html?filename=xilinx-zcu102-v2021.1-final.bsp).
...
3.  Build the PetaLinux project:
    ...
    - In the `<PetaLinux-project>` directory, e.g. ``xilinx-zcu102-2021.1``, build the Linux images using the following command:
