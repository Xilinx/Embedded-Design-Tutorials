...
- Download the respective BSP as described in [Example Project: Creating Linux Images Using PetaLinux](../docs/5-system-design-example.html#example-project-creating-linux-images-using-petalinux).
