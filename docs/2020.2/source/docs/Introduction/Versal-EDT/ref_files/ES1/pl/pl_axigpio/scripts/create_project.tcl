...
#set_property top versal_edt_wrapper [current_fileset]
#add_files -fileset constrs_1 -norecurse $constrs_dir/versal_edt_place.xdc
# add_files -fileset constrs_1 -norecurse $constrs_dir/loc_64_stream_sparse.xdc
# set_property used_in_synthesis false [get_files  $constrs_dir/loc_64_stream_sparse.xdc]
# add_files -fileset constrs_1 -norecurse $constrs_dir/tenzing_io.xdc
# set_property used_in_synthesis false [get_files  $constrs_dir/tenzing_io.xdc]
