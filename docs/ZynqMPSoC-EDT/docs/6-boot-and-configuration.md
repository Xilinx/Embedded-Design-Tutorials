...
- [Boot and Configuration](#boot-and-configuration)
  ...
  - [Secure Boot Sequence](#secure-boot-sequence)
    - [Secure Boot System Design Decisions](#secure-boot-system-design-decisions)
      - [Hardware Root of Trust](#hardware-root-of-trust)
        - [Data Integrity](#data-integrity)
        - [Authentication](#authentication)
      - [Boot Image Confidentiality and DPA](#boot-image-confidentiality-and-dpa)
      - [DPA Protections](#dpa-protections)
      - [Black Key Storage](#black-key-storage)
    - [Practical Methods in Secure Boot](#practical-methods-in-secure-boot)
      - [Sample Design Overview](#sample-design-overview)
      - [Generating Keys for Authentication](#generating-keys-for-authentication)
      - [Creating RSA Private/Public Key Pairs](#creating-rsa-privatepublic-key-pairs)
        - [Generate SHA3 of Public Key in RSA Private/Public Key Pair](#generate-sha3-of-public-key-in-rsa-privatepublic-key-pair)
        - [Additional RSA Private/Public Key Pairs](#additional-rsa-privatepublic-key-pairs)
        - [Enabling Boot Header Authentication](#enabling-boot-header-authentication)
      - [Generating Keys for Confidentiality](#generating-keys-for-confidentiality)
        - [Using AES Encryption](#using-aes-encryption)
        - [Enabling DPA Protections](#enabling-dpa-protections)
        ...
        - [Generating All of the AES Keys](#generating-all-of-the-aes-keys)
    - [Using Key Revocation](#using-key-revocation)
      - [Using the PUF](#using-the-puf)
      - [PUF Registration in Bootheader Mode](#puf-registration-in-bootheader-mode)
        - [Using PUF in Bootheader Mode](#using-puf-in-bootheader-mode)
        - [System Example Using the Vitis IDE Create Boot Image Wizard](#system-example-using-the-vitis-ide-create-boot-image-wizard)
      - [Booting the System Using a Secure Boot Image](#booting-the-system-using-a-secure-boot-image)
      - [Running the Linux Application](#running-the-linux-application)
      - [Sample BIF for a Fielded System](#sample-bif-for-a-fielded-system)
