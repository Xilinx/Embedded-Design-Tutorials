...
3. Change partition 0 to `qspi-boot` and set the size to `0xF40000`. Change partition 1 to `qspi-kernel` and set the size to `0x900000`. Delete any other partitions if they exist.
