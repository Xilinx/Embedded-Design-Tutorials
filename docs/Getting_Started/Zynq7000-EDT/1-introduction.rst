...
Visit the `Xilinx Download Center <https://www.xilinx.com/support/download.html>`_ to download the Vitis software platform. This tutorial is verified with 2025.1. If you are using other Vitis versions, some features or screenshots might differ.
