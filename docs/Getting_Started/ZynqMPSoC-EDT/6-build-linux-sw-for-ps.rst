...
1. Create a PetaLinux project using the following command:
   ...
   .. code:: bash
      ...
      petalinux-create -t project -s <path to the xilinx-zcu102-xsct-v2026.1-final.bsp>

   .. note:: ``xilinx-zcu102-xsct-v2026.1-final.bsp`` is the PetaLinux BSP for the ZCU102 Production Silicon Rev 1.0 Board.

   This creates a PetaLinux project directory, ``xilinx-zcu102-xsct-2026.1``.
...
3. Build the PetaLinux project:
   ...
   1. In the ``<PetaLinux-project>`` directory, for example, ``xilinx-zcu102-xsct-2026.1``, build the Linux images using the
      following command:
