...
int PsUartSetup(INTC *IntcInstPtr, XUartPs *UartInstPtr,
...
/*****************************************************************************/
/**
* This function is the main function for this application.
*
* @param	None.
*
...
*
* This handler is application specific and retained as a place holder for
* this application.
*
