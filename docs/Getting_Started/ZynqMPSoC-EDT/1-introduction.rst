...
For more information about the Vitis unified software platform, see *Vitis Unified Software Platform Documentation: Embedded Software Development* (`UG1400 <https://docs.amd.com/access/sources/dita/map?isLatest=true&url=ug1400-vitis-embedded&ft:locale=en-US>`_).
...
For more information, see the *PetaLinux Tools Documentation: Reference Guide* (`UG1144 <https://docs.amd.com/access/sources/dita/map?isLatest=true&url=ug1144-petalinux-tools-reference-guide&ft:locale=en-US>`_).
...
(`XD131 <https://docs.amd.com/access/sources/ftml/map?isLatest=true&url=xd131-zynq-embedded-design-tutorial&ft:locale=en-US>`_).
