...
4. Click **OK** to close the CIPS GUI. This sets the boot mode as OSPI.
...
1. Select the application project (helloworld_r5) in the Vitis Explorer
    ...
    >**Note:** The default linker always points to the DDR address
    available in memory.
...
### Example Project: Configuring the NoC IP Core in an Existing Project
 ...
 New Embedded Project with the Versal
...
3. Click **Run Block Automation**. The Run Block Automation dialog box
     opens as shown in the following figure.

    ![](./media/image37.jpeg)

4. Under PS/PMC, choose 1 for Memory Controller (DDR). This adds an AXI NoC IP as shown in the AXI NoC section of Run block automation.
