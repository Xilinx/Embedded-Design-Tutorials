- [Versal ACAP CIPS and NoC (DDR) IP Core Configuration](#versal-acap-cips-and-noc-ddr-ip-core-configuration)
  ...
  - [CIPS IP Core Configuration](#cips-ip-core-configuration)
    - [Creating a New Embedded Project with the Versal ACAP](#creating-a-new-embedded-project-with-the-versal-acap)
    ...
    - [Running a Bare-Metal Hello World Application](#running-a-bare-metal-hello-world-application)
  ...
  - [NoC (and DDR) IP Core Configuration](#noc-and-ddr-ip-core-configuration)
    - [Configuring the NoC IP Core in an Existing Project](#configuring-the-noc-ip-core-in-an-existing-project)
    ...
    - [Running a Bare-Metal Hello World Application on DDR Memory](#running-a-bare-metal-hello-world-application-on-ddr-memory)
