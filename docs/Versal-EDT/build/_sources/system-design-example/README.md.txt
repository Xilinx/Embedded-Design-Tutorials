...
4. In the Run Connection Automation dialog box, select the All
    ...
    This enables the automation for all the ports of the AXI GPIO IP.
...
11. Select the `aresetn` pin of the SmartConnect IP, right-click and select **Disconnect Pin**.
...
## Example Project: Creating Linux Images Using PetaLinux
 ...
 Xilinx&reg; Vitis&trade; software platform. This section explains how to
 configure and build the Linux operating system for an Arm&reg; Cortex&trade;-A72
 core- based APU on a Versal&trade; device. You can use the PetaLinux tool
...
- If you are using the VMK180 board, download the VMK180 PetaLinux 2020.1 BSP (xilinx- vmk180-v2020.1-final.bsp) from <https://www.xilinx.com/member/vmk180_headstart.html>.
