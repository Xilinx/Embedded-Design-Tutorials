...
| Linux Debug| Why do you see this error when you try to read a certain memory address?| System Debugger, Vitis Debug view, Variables view |[Error 3: Cannot Read Target Memory, Input/Output Error](/docs/Vitis-Embedded-Software-Debugging/docs/3-debugging-linux-applications#error-3-cannot-read-target-memory-input-output-error)|
