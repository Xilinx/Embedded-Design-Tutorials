...
This chapter guides you through building a system based on Zynq&reg;
 ...
 you configured in [Chapter 3: Build Software for PS
 Subsystems](#chapter-3) to create a Zynq&reg; UltraScale+ system. It does
...
### Configuring Software
 ...
 blocks will remain the same as mentioned in [Chapter](#chapter-3) [3:
 Build Software for PS Subsystems](#chapter-3). The software for this
...
2. Repeat steps 2 to 13 as described in [Example Project: Create Linux
     Images using
     PetaLinux](#example-project-create-linux-images-using-petalinux)
     to update the device tree and build Linux images using PetaLinux.
     Alternatively, you can also use the Linux image files shared with
     this tutorial. The images for this section can be found in `<design_files/design>`.

3. Follow step 15 to verify the images. The next step is to create a
     Bare-metal Application targeted for Arm Cortex-R5F based RPU.
 ...
 [Design Files for](#design-files-for-this-tutorial) [This
...
2. Set the workspace based on the project you created in [Chapter 2: Zynq UltraScale+ MPSoC Processing System Configuration](#chapter-2). For example: `C:\edt`.
...
8. Generate the Boot image for this design example as follows:
 ...
 This](#design-files-for-this-tutorial)
 [Tutorial](#design-files-for-this-tutorial). For more information, see
 the Xilinx Answer
