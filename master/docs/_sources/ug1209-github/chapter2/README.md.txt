# Build Software for PS Subsystems
 ...
 In [Chapter 2: Zynq UltraScale+ MPSoC Processing System
 Configuration](#chapter-2), you created and exported the hardware
...
### Create Custom Bare-Metal Application for Arm Cortex-A53 based APU
 ...
 created in [Example
 Project:](#example-project-running-the-hello-world-application-from-arm-cortex-a53)
 [Running the "Hello World" Application from Arm
...
12. Open **testapp.c** to review the source code for this application.
     ...
     processor to WFI mode. This application is reused and explained
     during runtime in [Chapter 5: Boot and
     Configuration](#_bookmark35).
...
2. Set the Workspace path based on the project you created in [Chapter
     2: Zynq UltraScale+ MPSoC Processing System
     Configuration](#chapter-2). For example, `C:\edt`.
...
## Example Project: Create Linux Images using PetaLinux
 ...
 >2.  This example uses the ZCU102 PetaLinux BSP to create a PetaLinux
...
2. Change to the PetaLinux project directory using the following
    ...
    Suite in [Chapter 2: Zynq UltraScale+ MPSoC Processing](#chapter-2)
...
7. One level above, that is, under Subsystem AUTO Hardware Settings, do
    ...
    b.  Based on this, the offset for Linux Images is calculated as
        0x1E40000 in QSPI Flash device. This will be used in [Chapter 5:
        Boot and Configuration](#_bookmark35), while creating Boot image
        for QSPI Boot-mode.
...
11. Take a backup of u-boot.elf and the other images. These will be used
     in [Chapter 5: Boot and Configuration](#_bookmark35).
 ...
 ***Note*:** For more information, refer to the *PetaLinux Tools
 ...
 these images in [Chapter 6: System Design Examples](#_bookmark60) to
 create Boot images for a specific design example.

 Next, you will debug software for Zynq UltraScale+ devices using the
 Vitis IDE in [Chapter 4:](#chapter-4) [Debugging with the Vitis
 Debugger](#chapter-4).